...
// Atualizar = Alterar dos dados de uma publicação no banco de dados
...
// Deç
func (repositorio Publicacoes) Deletar(publicacaoID uint64, publicacao modelos.Publicacao) error {
