...
VALUES
("Publicação do usuário 1","Essa é a publicação do usuário 4! Que Bom!", 13),
("Publicação do usuário 2","Essa é a publicação do usuário 3! Que Bom!", 1),
("Publicação do usuário 4","Essa é a publicação do usuário 2! Que Bom!", 1);