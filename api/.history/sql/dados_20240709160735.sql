...
VALUES
("Publicação testes","Essa é a publicação testes! Que Oba!", 13),
("Publicação testes","Essa é a publicação testes! Que Oba!", 6),
("Publicação testes","Essa é a publicação testes! Que Oba!", 2);