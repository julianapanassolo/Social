...
VALUES
("Publicação testes ","Essa é a publicação testes ! Que Bom!", 13),
("Publicação testes ","Essa é a publicação testes ! Que Bom!", 6),
("Publicação testes ","Essa é a publicação testes ! Que Bom!", 2);